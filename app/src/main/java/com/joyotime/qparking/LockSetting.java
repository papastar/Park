...
public class LockSetting extends Activity {
    ...
    String sn = null, bluetooth, key, _id, lockid, bluename, software, hardware, notename,
            locklong, locklat, cityname,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locksetting_ll_parkingnameLayout = (LinearLayout) findViewById(R.id
                .locksetting_ll_parkingname);
        ...
        locksetting_et_parkingname.setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (!hasFocus) {
                    ...
                    locksetting_tv_parkingname.setText(locksetting_et_parkingname.getText()
                            .toString());
                    locksetting_et_parkingname.setSelection(locksetting_tv_parkingname.getText()
                            .toString().length());
                }
            }
        ...
        locksetting_et_lcokaddress.setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (!hasFocus) {
                    ...
                    locksetting_tv_lcokaddress.setText(locksetting_et_lcokaddress.getText()
                            .toString());
                    locksetting_et_lcokaddress.setSelection(locksetting_tv_lcokaddress.getText()
                            .toString().length());
                }
            }
        });// setOnEditorActionListener
        ...
        locksetting_et_note.setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (!hasFocus) {
                    ...
                    locksetting_et_note.setSelection(locksetting_tv_note.getText().toString()
                            .length());
                }
            }
        });// setOnEditorActionListener
            ...
            try {
                switch (_key) {
                    ...
                    case 1:
                        ...
                        _retrueStr = InsterServiceData(LockTaKen, bluetooth, bluename, Login
                                        .m_Longitude, Login.m_Latitude,
                                lcokaddress, Login.m_citycode, Login.m_cityname, parkingname,
                                Login.m_addressde, note);
                        break;
                    ...
                    case 2:
                        ...
                        _retrueStr = UpdateData(sn, note1, Login.m_Longitude, Login.m_Latitude,
                                lcokaddress1,
                                Login.m_citycode, Login.m_cityname, parkingname1, Login
                                        .m_addressde);
                        break;
                    default:
                        break;
                ...
                if (result != null && !result.equals("There")) {
                    ...
                    switch (_key) {
                        ...
                        case 1:
                            ...
                            if (db.InstarBlueDBLocal(lockid, bluename, bluetooth, note, key, sn,
                                    LockTaKen,
                                    LockMain._OpenID, "1", "1", Login.m_Longitude, Login
                                            .m_Latitude, lcokaddress,
                                    Login.m_cityname, parkingname, Login.m_addressde, Login
                                            .m_citycode, "")) {
                        ...
                        case 2:
                            ...
                            try {
                                ...
                                String cityCode = jsObject.getJSONObject("parkingLot").optString
                                        ("cityCode");
                                ...
                                if (db.UpdateBlueDBLocal(bluetoothName, note2, skey, sn,
                                        slocktoken, lockLng, lockLat,
                                        lockAddress, cityName, parkingName, parkingAddress,
                                        cityCode, "")) {
                                    saveBdData(parkingName, sn, bluetoothName, note2, skey,
                                            slocktoken, lockLng, lockLat, lockAddress, cityName,
                                            parkingName, parkingAddress, cityCode);
                                    ShowToast("更新成功");
                                    finish();
                                    // new RequestTask().execute();
                                } else {
    ...
    private void saveBdData(String parkingName) {
        ...
        commonParam.put("rentState", String.valueOf(RentState.RENT_CAN.getState()));
        mRxManager.addSubscription(HttpManager.getInstance().getBaiduLBSApi().creatPoi
                (commonParam), new SubscriberCallBack<BaseBean>(new ApiCallback<BaseBean>() {
            @Override
    ...
    private void saveBdData(String parkingName, String sn, String bluename, String note, String
            key, String token, String lockLng, String locklat, String lockAddress, String
                                    cityname, String parkingname, String parkingaddress, String
            cityCode) {
        Map<String, String> commonParam = BaiduConfig.getCommonParam();
        commonParam.put("title", parkingName);
        commonParam.put("address", lockAddress);
        commonParam.put("tags", "车位");
        commonParam.put("latitude", locklat);
        commonParam.put("longitude", lockLng);
        commonParam.put("coord_type", "3");
        commonParam.put("lockerParkName", parkingName);
        commonParam.put("lockerId", lockid);
        commonParam.put("lockerBlueAddress", bluetooth);
        ...
        commonParam.put("lockerKey", key);
        commonParam.put("lockerSn", sn);
        commonParam.put("lockerToken", token);
        UserInfo userInfo = UserInfoManager.getInstance().getUserInfo();
        commonParam.put("ownerId", userInfo._id);
        commonParam.put("ownerName", userInfo.name);
        commonParam.put("ownerPhone", userInfo.cellphone);
    ...
    public String UpdateData(String isSN, String Note, String lockLng, String lockLat, String
            lockAddress,
                             String cityCode, String cityName, String parkingName, String
                                     parkingAddress)
    ...
    public String InsterServiceData(String lockerToken, String bluetooth, String bluetoothName,
                                    String lockLng,
                                    String lockLat, String lockAddress, String cityCode, String
                                            cityName, String parkingName,
                                    String parkingAddress, String note) throws
