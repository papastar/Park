...
public class BNavigatorActivity extends Activity {
	...
	private String Parkingnavigation = "false";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Intent PN = getIntent();
		Bundle bunPN = PN.getExtras();
		Parkingnavigation = bunPN.getString("Parkingnavigation");
		// 创建导航视图
...
//		BNMapController.getInstance().onResume();
	...
	public void onDestroy() {
		...
		super.onDestroy();
		// if (Parkingnavigation.equals("true"))
		// {
		// startActivity(new Intent(BNavigatorActivity.this, ParkingMap.class));
		// BNTTSPlayer.initPlayer();
		// BNTTSPlayer.playTTSText("正在初始化停车地图", -1);
		// }
