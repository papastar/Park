...
public class SimpleFooter implements Footable
{
	...
	public SimpleFooter(Context context)
	{
		...
		int fontSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 20, context.getResources().getDisplayMetrics());
		mPaint.setTextSize(fontSize);
		mPaint.setTextAlign(Align.CENTER);
		mCircleColor = 0xffffffff;
		mHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 30, context.getResources().getDisplayMetrics());
	}
