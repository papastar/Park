...
public class SimpleHeader implements Headable {
	...
	public SimpleHeader(Context context) {
		...
		int fontSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 20,
		...
		mHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 45,
				context.getResources().getDisplayMetrics());
		mPointRadius = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2.5f,
				context.getResources().getDisplayMetrics());
