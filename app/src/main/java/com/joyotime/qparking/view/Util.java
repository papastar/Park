...
//		DisplayImageOptions defaultOptions = new DisplayImageOptions.Builder().showImageOnLoading(R.drawable.img_head).showImageForEmptyUri(R.drawable.head).showImageOnFail(R.drawable.head)
//				.cacheInMemory(true).considerExifParams(true).displayer(new FadeInBitmapDisplayer(300, true, true, true)).imageScaleType(ImageScaleType.EXACTLY_STRETCHED)
...
//		ImageLoader.getInstance().init(config);
	...
	public static ArrayList<String> getGalleryPhotos(Activity act)
	{
		...
		try
		{
			...
			Cursor imagecursor = act.managedQuery(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, columns, null, null, orderBy);
