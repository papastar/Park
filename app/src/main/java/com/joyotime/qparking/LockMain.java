...
public class LockMain extends Activity implements SensorEventListener {
    ...
    private TextView lockmain_tv_about;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lockmain_username = (TextView) findViewById(R.id.locker_name_tv);
        lockmain_headimage = (ImageView) findViewById(R.id.head_img);
        ...
        lockmain_tv_about = (TextView) findViewById(R.id.about_tv);
        ...
        lockmain_login_ll = (RelativeLayout) findViewById(R.id.user_info_layout);
...
//					// i.setData(Uri.parse("https://item.taobao.com/item.htm?spm=a230r.1.14.1
// .syElve&id=45763485020&ns=1&abbucket=12#detail"));
//					// startActivity(i);
...
//					intent5.putExtra(
//							"url",
//							"https://item.taobao.com/item.htm?spm=a230r.1.14.1
// .syElve&id=45763485020&ns=1&abbucket=12#detail");
...
//        }
        ...
        findViewById(R.id.user_info_layout).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LockMain.this, UserInfoActivity.class));
            }
        });
...
//        }
        ...
        findViewById(R.id.lock_manager_tv).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent intent1 = new Intent();
//					intent1.setClass(LockMain.this, LockManage.class);
//					startActivityForResult(intent1, 3);
                startActivity(new Intent(LockMain.this, LockersActivity.class));
            }
        });
...
//        }
        ...
        findViewById(R.id.my_rent_tv).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LockMain.this, MyRentActivity.class));
            }
        });
...
//        }
        ...
        findViewById(R.id.wallet_tv).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LockMain.this, MyWalletActivity.class));
            }
        });
...
//        }
        ...
        findViewById(R.id.rent_locker_tv).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LockMain.this, LockerMapActivity.class));
            }
        });
...
//        }
        ...
        findViewById(R.id.add_locker_tv).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(LockMain.this, SearchCarLock.class);
                intent.putExtra("automatic", "false");
                startActivityForResult(intent, 1);
                //startActivity(new Intent(LockMain.this,SearchLockActivity.class));
            }
        });
    ...
    private BluetoothLeClass.OnServiceDiscoverListener mOnServiceDiscover = new BluetoothLeClass
            .OnServiceDiscoverListener() {
     ...
     * 收到BLE终端数据交互的事�?
     */
    private BluetoothLeClass.OnDataAvailableListener mOnDataAvailable = new BluetoothLeClass
    ...
    private static void ShowToast(String msg) {
        Toast.makeText(lockmain_contextmian, msg, Toast.LENGTH_SHORT).show();
    }
    ...
    private static void initView(List<Map<String, Object>> data) {
        ...
        if ((AppSetting.AppVCode > mdb.getVersion() && AppSetting.AppVCode > 0)
                || (AppSetting.mSoftWare > 0 && AppSetting.mSoftWare < AppSetting
                .serviceSoftVersion)) {
        ...
        public void handleMessage(Message msg) {
            if (msg.what <= 100 && msg.what > 0) {
                ...
                if (progressDialog != null && tv_tomattext != null
                    ...
                    lockmain_link.setBackgroundResource(R.drawable.gen_icon_link);
                    lockBoolea = false;
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        // //
        // Log.d(TAG,"its array:"+its+"sensor type :"+event.sensor.getType()+" proximity
