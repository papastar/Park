...
//        mDivider = a.getDrawable(0);
    ...
    public void drawVerticalDividers(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (divider == null)
                break;
            final int top = child.getBottom() + params.bottomMargin + Math.round(ViewCompat
    ...
    public void drawHorizontalDividers(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (divider == null)
                break;
            final int left = child.getRight() + params.rightMargin + Math.round(ViewCompat
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State
        ...
        if (mDividerOffsets.indexOfKey(adapterPosition) < 0) {
            Drawable divider = getDivider(parent, adapterPosition);
            if (divider != null)
                mDividerOffsets.put(adapterPosition, divider
                        .getIntrinsicHeight());
        }
