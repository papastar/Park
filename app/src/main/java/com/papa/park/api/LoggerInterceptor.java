...
//                        Log.d(tag, "responseBody's contentType : " + mediaType.toString());
                        if (isText(mediaType)) {
                            ...
                            Log.d(tag, "responseBody's content : " + " maybe [file part] , too " +
...
//                    Log.d(tag, "requestBody's contentType : " + mediaType.toString());
                    if (isText(mediaType)) {
                        Log.d(tag, "requestBody's content : " + URLDecoder.decode(bodyToString
                                (request)));
                    } else {
                        Log.d(tag, "requestBody's content : " + " maybe [file part] , too large " +
                                "too print , ignored!");
                    }
                }
            }
...
//          e.printStackTrace();
    ...
    private boolean isText(MediaType mediaType) {
        if (mediaType.type() != null && (mediaType.type().equals("text") || mediaType.type()
                .equals("application"))) {
            return true;
        }
